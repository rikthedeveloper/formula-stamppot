...
## General Guidelines
- Follow the .NET C# coding conventions as configured in the `.editorconfig` file.
...
## Code Structure
- Group types together in one file when it makes sense. For example:
  - Enums that are strongly related to the main class in the file.
  - Request / Response DTO's in Web API Controllers or Minimal API endpoints.
