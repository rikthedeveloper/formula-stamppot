...
public readonly record struct DriverId(long Value) : IEquatable<DriverId>, ITryParseable<string, DriverId>, IFormattable
{
    ...
    public static bool TryParse(string? value, out DriverId @out)
    {
